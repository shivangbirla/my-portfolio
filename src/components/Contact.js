    ...
    <section className="py-16 lg:section" id="contact">
      <div className="container mx-auto">
        <div className="flex flex-col lg:flex-row">
          ...
          >
            <div>
              <h4 className="text-[22px] uppercase text-accent font-medium ml-2 mb-2 tracking-wide">
                Get in touch
              </h4>
              <h2 className="text-[45px] lg:text-[65px] leading-none ml-1 mb-12 text-[#ced4da]">
